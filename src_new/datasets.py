...
from src_new.transforms import get_valid_transforms, get_train_transforms
...
class DatasetAdaptor:
    def __init__(self, images_dir_path, annotations_dataframe):
        ...
        self.images = self.annotations_df.external_id.unique().tolist()
    ...
    def get_image_and_labels_by_idx(self, idx):
        ...
        return image, pascal_bboxes, class_labels, idx
